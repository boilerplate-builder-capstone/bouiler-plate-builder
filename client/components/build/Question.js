...
function Question(props) {
    ...
    const currQuestion = backEndQuestions[questionIdx]
    ...
    const handleSubmit = (ev) => {
        ...
        setQuestionIdx(currQuestion[yesOrNo])
    ...
    return (
        <div id="questioncontainer">
            ...
            {/* <button onClick={() => console.log(backEndQuestions[questionIdx])}>see question idx</button> */}
        </div>
    )
}
