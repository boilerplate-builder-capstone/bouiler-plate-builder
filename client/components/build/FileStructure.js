...
function FileStructure(props) {
    ...
    useEffect(() => {
        ...
        // previousBody = prevBodyRef.current
        // console.log('previousBody:', previousBody)
    }, [body]);

    useEffect(() => {
        console.log('file structure rendered')
    })
    ...
    return (
        <div id="filestructure">
            ...
            <h3>{Object.keys(body).length ? `Now: ${Object.keys(body)} Previous: ${Object.keys(previousBody)}` : null}</h3>
            <ul>
                        ...
                        if (key === "server" && val){
                            return (
                                <div key={idx}>
                                    <li>SERVER</li>
                                    <ul>
                                        <li id="startserver">startserver.js</li>
                                        <li id="modifyserver">modifyserver.js</li>
                                        {val.db
                                            ? <div>
                                                <li>DB</li>
                                                <ul>
